...
body {
	...
	background-image: url("{{ asset('images/or-kochi-bg.jpg') }}");
	...
	<div class="wrapper">
		...
		<div class="content" id="grid">
			...
			<section id="content">
				...
				<p>
					<ul>
						<li>Learn basic electronics and mechanics (motors, gears etc.)</li>
						<li>Control of servo motor using Arduino.</li>
						<li>Basics of image processing on Python using OpenCV.</li>
						<li>Development of a Robotic Arm with two degrees of freedom.</li>
						<li>Interfacing robotic arm with arm gestures as control input.</li>
					</ul>
				</p>
				<p>
					Participants would be able to,
					<ul>
						<li>Understand the working of servo motors</li>
						<li>Apply servo motors in developing systems requiring precision.</li>
						<li> Interface motors with Arduino UNO.</li>
						<li> Implement Object Tracking in Image Processing.</li>
						<li>Implement basic control system concepts.</li>
					</ul>
				</p>
			</section>
			<section id="details">
				...
				<ul style="display: inline-block;">
					...
					<li>VENUE:<br>
						...
						RAJAGIRI VALLEY ROAD,<br>
						RAJAGIRI VALLEY,<br>
						KAKKANAD, KOCHI - 682 039, KERALA, INDIA.<br>
					</li>
			...
			<section id="rules">
				...
				<ul>
					...
					<li>
						PREREQUISITES:<br>
						Each team should bring one laptop with fully functioning web-cam with Windows 8 OS or above.
					</li>
					<li>
						CERTIFICATE:<br>
