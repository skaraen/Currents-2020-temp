...
body {
	...
	background-image: url("{{ asset('images/or-bang-bg-2.jpeg') }}");
	...
	<div class="wrapper">
		...
		<div class="content" id="grid">
			...
			<section id="content">
				...
				<p>
					<ul>
						<li>Introduction to the components provided as a part of the CURRENTS Kit</li>
			...
			<section id="details">
				...
				<ul style="display: inline-block;">
					<li>DATE: 26th - 27th January 2019</li>
					<li>DURATION: 2 Day </li>
					<li>VENUE:<br>
						B.M.S COLLEGE OF ENGINEERING,<br>
						P.O. BOX NO.: 1908, BULL TEMPLE ROAD,<br>
						BASAVANAGUDI,<br>
						BENGALURU - 560 019, KARNATAKA, INDIA.<br>
					</li>
					<li>TIMINGS: 9 AM to 5 PM</li>
					<li>COST OF WORKSHOP: INR 3,300/- for a Team</li>
					<li>A Team can consist of maximum 3 members.</li>
					<li><strong>Limited number of seats</strong></li>
				</ul>
				<span class="map_sec" style="float: right"><iframe frameborder="0" height="285px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6539.621166266366!2d77.5599382083865!3d12.940979065123205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x5f4adbdbab8bd80f!2sBMS+College+of+Engineering!5e0!3m2!1sen!2sin!4v1495623173140" style="border:1px solid #e6eae3" width="100%"></iframe></span>
			</section>
			<section id="rules">
				<h1>Rules</h1>
				<ul>
					...
					<li>
						...
						Participants will have to register in a team with maximum of three members in it.
					</li>
					<li>
						PREREQUISITES:<br>
			...
			<section id="contact">
				<h1>Contact</h1>
				<p>LAXMAN BALAJI<br>+91-94872 25817</p>
				<p>DHEDEEPYA<br>+91-95000 78541</p>
