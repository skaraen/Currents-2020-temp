    ...
    <form id="contact" onsubmit="register(); return false;" action="" method="post">
        ...
        <fieldset>
            <select id="theme">
                ...
                <option value="1">Environmental issues: Causes and Consequences of climatic change</option>
                <option value="2">Biodiversity: Conservation</option>
                <option value="3">Life Science in Human Welfare</option>
                <option value="4">Alternative Energy: Green Energy</option>
                <option value="5">Transport and Communication Technology</option>
                <option value="6">Mathematical Modeling and Sports</option>
            </select>
        </fieldset>
        <fieldset>
